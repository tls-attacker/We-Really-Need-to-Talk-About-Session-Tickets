# Vulnerable BoringSSL Server

This is a fork of BoringSSL which is maintained at https://git.cs.uni-paderborn.de/snhebrok/vulnerable-bssl.
We copied the files here to have a stable reference for the artefact to test against.
